...
-   Wie koordinieren und managen wir ein komplexes Projekt mit mehreren Mitarbeitern unter Zeitdruck? (Projektmanagement)
...
-   für das eigene Projekt kann jede Gruppe so viele oder wenige automatische Verfahren verwenden, wie sie will
...
-   Protokollierung der Diskussionsprozesse in der AG
-   Vorbereitung einer Kurzpräsentation (5 min) mit 3-4 Folien
-   Upload von Folien spätestens Di 8h, Präsentation in der Sitzung
...
## Aufgabe: aktuelle Experimentalforschung

- recherchieren Sie zu zweit je eine aktuelle Experimentalstudie in der Kommunikationswissenschaft
- Basis sind die Top 20 Journals nach Scimago Ranking <https://www.scimagojr.com/journalrank.php?area=3300&category=3315>
- besprechen Sie die gefundende Studie paarweise und fassen Sie in max. einer Minute (!) zusammen: Thema, Forschungsfrage, Experimentaldesign und -bedingungen, Outcome-Variablen, Ergebnisse, Fazit
- finden Sie min. einen offensichtlichen Kritikpunkt
- laden Sie die PDF in Moodle hoch
...
-   Relevant sind grob Thema, Versuchsbedingungen, Outcome-Variablen

## Literatur

::: {layout-ncol="2"}
Koch, T., Seeger, C., & Müller, P. (2025). *Das Experiment in der Kommunikations- und Medienwissenschaft*. Grundlagen, Durchführung und Auswertung experimenteller Forschung. 2. Auflage. Wiesbaden: Springer VS.

![](koch25.png){width="480"}
:::
...
Stellen Sie sich und Ihren Themenvorschlag kurz vor!
...
![Quelle: @koch2025](images/kausal_koch.png)
...
2.  Recherchieren Sie mindestens 4 thematisch verwandte Studien, vorzugsweise Experimente.
...
## Übergang: Klassische ABM vs. Generative Agenten

-   Klassische ABM: Programmierer schreibt explizite Regeln
-   Generative Agenten: LLM interpretiert sprachliche Anweisungen
-   Beide haben Agenten, Umwelt, Interaktionen
-   Generative Agenten erlauben komplexere Verhalten, aber weniger Kontrolle
...
## Brücke zur nächsten Sitzung

Die Power-Analyse heute hilft Ihnen, in der nächsten Sitzung:

-   Ihr Forschungsdesign zu konkretisieren
-   Eine realistische Stichprobenplanung zu erstellen
-   Beides auf Ihre Forschungsfrage und Hypothesen abzustimmen

Denken Sie schon einmal nach: Welches Design (Between/Within) passt zu Ihrer Forschungsfrage?

## Aufgaben zur nächsten Sitzung

-   praktische Übung nachbereiten <https://stats.ifp.uni-mainz.de/ba-ccs-track/exp-simulation.html>
-   Hausaufgabe in R erledigen
-   Erste Überlegungen zu Forschungsdesign und Stichprobe
...
![Quelle: @koch2025](images/clipboard-1783332828.png)

## Between- und Within-Subject-Design

![Quelle: @koch2025](images/clipboard-2151872876.png)
...
-   oft werden Manipulationschecks einfach empfohlen, aber zu bedenken:
    1.  Ist es nötig, dass die Teilnehmenden die Manipulation erkennen?
...
-   **Platzierung der Messung**: Reihenfolgen-, Ausstrahlungs- und andere Fragebogeneffekte (insb. Platzierung des Manipulationschecks)
...
-   **Schritt 4**: Für Messung entscheiden, ggf. übersetzen/an Gegenstand anpassen/ auf 1-3 Items kürzen (insb. für within-subjects Design)
...
-   **Freiwilligkeit**: Teilnehmende müssen explizit einen Button klicken, um zuzustimmen
...
- gern und viel verwenden (an LeserInnen denken!)
