...
start_date = as.Date("2026-04-14")
end_date = as.Date("2026-07-07")
no_classes = as.Date(c("2025-04-21", "2025-06-09"))
topics = "Einführung, Themen, CCS: Forschungsfragen & Hypothesen, CCS: Simulation, Studiendesign und Stichprobe*, CCS: Stimuluserstellung*, 
...
-   Agentenbasierte Modelle (ABM) und generative Agenten mit LLM
-   Monte-Carlo-Simulation und Power-Analyse
-   praktische R-Übung
...
### Aufgabe zur nächste Sitzung

-   [R-Hausaufgabe zur Simulation](https://stats.ifp.uni-mainz.de/ba-ccs-track/exp-simulation.html)
-   Erste Überlegungen zu Forschungsdesign und Stichprobe für Ihr eigenes Experiment
