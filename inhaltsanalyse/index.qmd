...
topics = "Einführung und Grundlagen, Themenwahl und Forschungsfragen, CCS: Datenerhebung, Studiendesign und Stichprobe*, Kategorien und Codierung*, Codebuch-Finalisierung, CCS: Inhaltsanalyse mit LLM*, Reliabilitätstest, Feldphase (keine Sitzung),  Datenaufbereitung und -analyse*,  CCS: Zero-Shot Codierung I, CCS: Zero-Shot Codierung II, Visualisierung und Ergebnisaufbereitung, Abschluss" |> str_split_1(", ") |> str_squish()
```
...
- <https://stats.ifp.uni-mainz.de/ba-ccs-track/ia-daten.html#hausaufgabe> 
...
- [CCS-Hausaufgabe](https://stats.ifp.uni-mainz.de/ba-ccs-track/ia-zeroshot.html)
...
## Sitzung 14 <a class="bi bi-easel-fill" href="slides.html#/s14" alt="Folien"></a> {#14}
