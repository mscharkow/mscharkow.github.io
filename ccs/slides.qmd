...
|:------------|:------|:------|:------|:------|:------|:------|:------|:------|:------|:-------|
| 1           | 0.78  | 0.15  | 0.92  | 0.23  | 0.65  | 0.42  | 0.81  | 0.19  | 0.70  | 0.33   |
| 2           | 0.21  | 0.89  | 0.10  | 0.77  | 0.33  | 0.95  | 0.05  | 0.68  | 0.25  | 0.87   |
| 3           | 0.62  | 0.35  | 0.75  | 0.12  | 0.88  | 0.08  | 0.59  | 0.30  | 0.91  | 0.17   |
...
* Basic workflow is similar to manual content analysis:
  ...
  1. Develop codebook with coding instructions and examples.
  2. Combine instructions with text/image data to prompts for LLM API.
  3. Collect structured predictions for each coding unit from the model.
  4. Maybe combine different predictions (varying tasks, varying LLM/LMM)
