...
-   example 1: [Wikipedia Views API](https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/de.wikipedia/all-access/all-agents/Deutscher_Bun%20destag/daily/20240101/20250101), aggregate views per day
...
1. You can submit each homework until the start of the next topic (e.g. from now until we start with content analysis).
