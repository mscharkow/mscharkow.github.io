...
start_date = as.Date("2026-04-15")
end_date = as.Date("2026-07-08")
no_classes = as.Date(c())
topics = "Introduction, Computational Workflows and Writing, CCS Paper Potpourri, Ethical and legal perspectives, Digital trace data, Digital trace data, Automatic content analysis, Automatic content analysis, Automatic content analysis, Simulation and computational experiments, Simulation and computational experiments, Q & A" |> str_split_1(", ") |> str_squish()
...
-   Writing papers with statistical analyses: reproducible research and literate programming
-   Knitr and Quarto: integrating R code, automated result inclusion, versatile document conversion
-   Markdown basics, YAML headers, Quarto workflow features, and scrollytelling with {closeread}

### Reading

None (practical session)

### Tasks for the next session

Prepare your poster presentation for Session 3.
...
## Session 12 <a class="bi bi-easel-fill" href="slides.html#/s12" alt="Slides"></a> {#12}